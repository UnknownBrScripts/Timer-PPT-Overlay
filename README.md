...
Saída padrão:
- `Timer PPT Standalone/bin/Debug`
- `Timer PPT Standalone/bin/Release`
...
- Projeto standalone: `src/Timer PPT Standalone/`
  - Entrada do app/tray/instância única: `Program.cs`
  - Overlay e interações: `TimerForm.cs`
  - Configurações (Registry): `TimerSettings.cs`
  - Tela de configurações: `TimerSettingsForm.cs`
